...
const uri =  "mongodb://root:4awwlN5fFHuLJYV9YCUPHqiC@172.21.155.69:27017";
...
app.post('/register', async (req, res) => {
    ...
    try {
        ...
        // Redirect to /index with username on successful registration
...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        // Redirect to /index with username on successful login
